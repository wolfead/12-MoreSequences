...
def run_test_draw_points_on_circle():
    ...
    # -------------------------------------------------------------------------
    title = 'Draw Points on Circle, test 1: 60 purple dots.'
    window = rg.RoseWindow(400,400,title)
...
def run_test_fancy_polygon():
    ...
    # -------------------------------------------------------------------------
    title = 'FANCY POLYGON test 4: 100 pink lines on white circle,with hops of 35'
    window = rg.RoseWindow(400,400,title)
    circle = rg.Circle(rg.Point(200,200),180)
    circle.fill_color = 'white'
    fancy_polygon(window,circle, 100, 35, 'pink', 1)
    window.close_on_mouse_click()
